		    ...
		    <ul class="navbar-nav ml-auto">
		      ...
		      <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		          ...
		          <a class="dropdown-item" href="../php/categorias.php">Categorías</a>
		          <a class="dropdown-item" href="../php/productosxcategoria.php">Productos por Categoría</a>
		          <a class="dropdown-item" href="#">Consultas</a>
		        </div>
		      </li>
		      <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		          ...
		          <a class="dropdown-item" href="../php/nuevoVendedeor.php">Agregar Usuario</a>
		          <a class="dropdown-item" href="#">Consultas</a>
		        </div>
		      </li>
		      <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		          <a class="dropdown-item" href="close.php">Cerrar Sesión</a></a>
		        </div>
		      </li>
		    </ul>
		  </div>

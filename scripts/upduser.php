...
<head>
    <meta charset="UTF-8">
    <title>Actualizand Usuario</title>
...
<!-- ***************Inicio del sitio******************* -->
	<div class="container">
		...
		$tel = $telefono;
		$cadena="UPDATE usuarios SET nombre='$nombre',apellidos='$apellidos',correo='$correo',telefono='$telefono',fecha_nac='$fnacimiento',domicilio='$domicilio',tipo_usuario='$tipo' WHERE id='$id'";
